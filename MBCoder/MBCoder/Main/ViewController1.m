...
- (void)initialize {
    self.tableArray = @[@"生命周期/圆形绘制",@"autoreleasepool、assign、Tagged Pointer",@"线程",@"block",@"copy和指针常量、常量指针",@"layout方法",@"WebAssembly",@"tableview滑动卡顿",@"消息机制",@"关联对象和weak属性",@"响应者链",@"RunLoop",@"Runtime",@"Cateory和load、initialize",@"多继承、NSProxy",@"KVO",@"时间戳",@"组件化",@"iOS 开发中的锁",@"加载高清大图处理（待删除）",@"离屏渲染",@"排序查找算法",@"Mach-O文件格式和启动优化",@"https、TCP、socket",@"CoreAnimation",@"Layer",@"CoreGraphics",@"数据库-表之间的关系和查询方式",@"数据库-其他",@"CoreSpotlight",@"UIScrollView（待删除）",@"未知",@"新闻详情页",@"GCDObjC",@"模型打印",@"NSLogger",@"RAC",@"MVVM",@"内存管理",@"内联，动态库",@"宏定义",@"旋转缩放平移",@"原子性"];
}
